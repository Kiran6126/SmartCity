...
function useFetcher({
  ...
  let load = React.useCallback(
    async (href, opts) => {
      _chunkQSNCZFX5js.invariant.call(void 0, routeId, "No routeId available for fetcher.load()");
  ...
  let fetcher = state.fetchers.get(fetcherKey) || _chunkQSNCZFX5js.IDLE_FETCHER;
  ...
  if (getKey) {
    if (basename !== "/") {
      key = getKey(
        {
          ...location,
          pathname: _chunkQSNCZFX5js.stripBasename.call(void 0, location.pathname, basename) || location.pathname
        },
        matches
      );
    } else {
...
function useScrollRestoration({
  ...
  let location = _chunkQSNCZFX5js.useLocation.call(void 0, );
  let matches = _chunkQSNCZFX5js.useMatches.call(void 0, );
  let navigation = _chunkQSNCZFX5js.useNavigation.call(void 0, );
  React.useEffect(() => {
...
function usePrompt({
  ...
  let blocker = _chunkQSNCZFX5js.useBlocker.call(void 0, when);
  React.useEffect(() => {
...
function useViewTransitionState(to, { relative } = {}) {
  let vtContext = React.useContext(_chunkQSNCZFX5js.ViewTransitionContext);
  _chunkQSNCZFX5js.invariant.call(void 0, 
    vtContext != null,
  ...
  let currentPath = _chunkQSNCZFX5js.stripBasename.call(void 0, vtContext.currentLocation.pathname, basename) || vtContext.currentLocation.pathname;
  let nextPath = _chunkQSNCZFX5js.stripBasename.call(void 0, vtContext.nextLocation.pathname, basename) || vtContext.nextLocation.pathname;
  return _chunkQSNCZFX5js.matchPath.call(void 0, path.pathname, nextPath) != null || _chunkQSNCZFX5js.matchPath.call(void 0, path.pathname, currentPath) != null;
}
...
function StaticRouter({
  ...
  if (typeof locationProp === "string") {
    locationProp = _chunkQSNCZFX5js.parsePath.call(void 0, locationProp);
  }
  let action = "POP" /* Pop */;
  let location = {
...
function StaticRouterProvider({
  ...
  if (hydrate !== false) {
    ...
    let json = _chunkQSNCZFX5js.escapeHtml.call(void 0, JSON.stringify(JSON.stringify(data)));
    hydrateScript = `window.__staticRouterHydrationData = JSON.parse(${json});`;
  }
  let { state } = dataRouterContext.router;
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(_chunkQSNCZFX5js.DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React2.createElement(_chunkQSNCZFX5js.DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React2.createElement(_chunkQSNCZFX5js.FetchersContext.Provider, { value: fetchersContext }, /* @__PURE__ */ React2.createElement(_chunkQSNCZFX5js.ViewTransitionContext.Provider, { value: { isTransitioning: false } }, /* @__PURE__ */ React2.createElement(
    _chunkQSNCZFX5js.Router,
    {
...
function DataRoutes({
  ...
  return _chunkQSNCZFX5js.useRoutesImpl.call(void 0, routes, void 0, state, void 0, future);
}
...
function createStaticHandler2(routes, opts) {
  return _chunkQSNCZFX5js.createStaticHandler.call(void 0, routes, {
    ...opts,
    mapRouteProperties: _chunkQSNCZFX5js.mapRouteProperties
  });
}
function createStaticRouter(routes, context, opts = {}) {
  let manifest = {};
  let dataRoutes = _chunkQSNCZFX5js.convertRoutesToDataRoutes.call(void 0, 
    routes,
    _chunkQSNCZFX5js.mapRouteProperties,
    void 0,
    manifest
  );
  ...
  return {
    ...
    get state() {
      return {
        ...
        initialized: true,
        navigation: _chunkQSNCZFX5js.IDLE_NAVIGATION,
    ...
    encodeLocation,
    getFetcher() {
      return _chunkQSNCZFX5js.IDLE_FETCHER;
    },
    deleteFetcher() {
    ...
    getBlocker() {
      return _chunkQSNCZFX5js.IDLE_BLOCKER;
    },
    deleteBlocker() {
...
function createHref(to) {
  return typeof to === "string" ? to : _chunkQSNCZFX5js.createPath.call(void 0, to);
}
function encodeLocation(to) {
  let href = typeof to === "string" ? to : _chunkQSNCZFX5js.createPath.call(void 0, to);
