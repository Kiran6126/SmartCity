 ...
 *
 * ```tsx filename=src/routes/dashboard.jsx lines=[14,20]
 ...
 * ```
 *
 * ```tsx filename=src/routes/dashboard/messages.jsx lines=[1,4]
 ...
 *
 * // or in routes.ts
 * route("/posts/:postId", "routes/post.jsx");
 * ```
 *
 ...
 * | ---------------------------- | ---------------------- |
 * | `app/root.jsx`               | `"root"`               |
 * | `app/routes/teams.jsx`       | `"routes/teams"`       |
 * | `app/whatever/teams.$id.jsx` | `"whatever/teams.$id"` |
 *
 * @example
 ...
 * route("/", "containers/app.jsx", { id: "app" })
 ...
 * [`entry.server.jsx`](../framework-conventions/entry.server.jsx).
 *
 * @public
